...
export const MenuBar = ({ openHelp, uploadNewPdf, addDrawing, addText, addImage, isPdfLoaded, savingPdfStatus, savePdf, }) => (<Menu pointing>
    ...
    <Menu.Menu position="right">
      {isPdfLoaded && (<>
          ...
          <Menu.Item data-testid='save-menu-item' name={savingPdfStatus ? 'Saving...' : 'Save'} disabled={savingPdfStatus} onClick={savePdf}/>
